...
sudo apt-get -y install build-essential cmake libfreeimage-dev freeglut3 freeglut3-dev libglew1.5 libglew1.5-dev libglu1-mesa libglu1-mesa-dev libgl1-mesa-glx libgl1-mesa-dev libglfw3-dev libcegui-mk2-0.8.4 libxmu-dev libxi-dev subversion mercurial libarchive-dev python3-dev libois-dev libsdl2-dev libsfml-dev yasm scons libfontconfig1-dev libfreetype6-dev libpng-dev libcairo2-dev libtiff5-dev libxaw7-dev
